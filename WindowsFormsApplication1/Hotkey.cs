...
namespace HotKeyMgr
{
    public class Hotkey : IMessageFilter
    {
        ...
        private List<string> sendKey;
        private List<string> keyName;

        public List<string> SendKey
        {
            get { return sendKey; }
            set { sendKey = value; }
        }
        ...
        public Hotkey(Keys keyCode, bool shift, bool control, bool alt, bool windows, string sendKey, string command, string keyName)
        {
            // Assign properties
            ...
            this.SendKey = new List<string>() { sendKey };
            this.execCommand = new List<string>() { command };
            this.keyName = new List<string>() { keyName };
            // Register us as a message filter
            Application.AddMessageFilter(this);
        }

        public Hotkey(Keys keyCode, bool shift, bool control, bool alt, bool windows, List<string> sendKey, List<string> commands, List<string> keyName)
        {
            // Assign properties
            this.KeyCode = keyCode;
            this.Shift = shift;
        ...
        public Hotkey Clone()
        {
            ...
            return new Hotkey(this.keyCode, this.shift, this.control, this.alt, this.windows, this.sendKey, this.execCommand, this.keyName);
        }
